...
export const metadata: Metadata = {
  title: 'Performance',
  description: 'Cold air intakes, exhausts, and performance upgrades for your truck or SUV.',
}
      ...
      <div className="mx-auto max-w-7xl px-4 py-10">
        <div className="mb-8 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500">Intakes, exhausts, tuners — built for your engine.</p>
          </div>
          <div className="w-full max-w-xs">
            <VehicleSelector compact />
          </div>
        </div>
        <FitmentFilter categorySlug="performance" />
      </div>
    </main>
  )
}
